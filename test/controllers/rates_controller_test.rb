...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { comments: @rate.comments, presentation: @rate.presentation, punctuality: @rate.punctuality, quality: @rate.quality }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { comments: @rate.comments, presentation: @rate.presentation, punctuality: @rate.punctuality, quality: @rate.quality }
    assert_redirected_to rate_path(assigns(:rate))
  end
