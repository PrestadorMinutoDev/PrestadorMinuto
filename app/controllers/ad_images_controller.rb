class AdImagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ad_image.save
        format.html { redirect_to @ad_image, notice: 'Ad image was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @ad_image.update(ad_image_params)
        format.html { redirect_to @ad_image, notice: 'Ad image was successfully updated.' }
  ...
  def destroy
    @ad_image.destroy
    respond_to do |format|
      format.html { redirect_to ad_images_url, notice: 'Ad image was successfully destroyed.' }
  ...
  private
    ...
    def ad_image_params
      params.require(:ad_image).permit(:ad_id, :image_id)
    end
end
